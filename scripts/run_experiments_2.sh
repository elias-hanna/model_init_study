...
# environments=(redundant_arm fetch_pick_and_place)
# pred_error_plot_upper_limits=(1.25 2.5) # warning needs to be in same order as envs
# disagr_plot_upper_limits=(1.25 0.3) # warning needs to be in same order as envs
